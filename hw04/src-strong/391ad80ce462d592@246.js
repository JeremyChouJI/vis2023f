...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>內圈由深至淺分別代表了，填問卷者認為自己對SDGs的了解程度，顏色越深越是了解。</li>
    <li>與填問卷者願不願意瞭解更多內容對照。</li>
    <li>可以發現不論填問卷者不論了不了解都願意瞭解更多內容，有可能因為近年氣候異常的速度過於迅速，普遍人對於永續發展的議題更加有興趣。</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["1", "2" ,"3", "4", "5","願意","不願意"])
  //.range(d3.schemePaired)
  .range(["#F4ECF7","#D2B4DE","#A569BD","#7D3C98","#5B2C6F","#3498DB","#C0392B"])
  .unknown("#BEBEBE")
)}
