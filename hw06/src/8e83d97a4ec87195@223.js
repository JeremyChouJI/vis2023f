...
md`#  HW06 - Simple&Medium&Strong baseline(10pt)`
)}
...
Plot.plot({
  ...
  color: {
    ...
    range: ['#7D3C98', '#D0FF00'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
  ...
  series.forEach((serie) => {
      ...
      bars.enter().append("rect")
          ...
          .on("mouseover", function(d) {
              d3.select(this).attr("fill", "#85C1E9");
...
md`Reference：
<li>https://observablehq.com/d/3b039b075022c35e</li>`
)}
